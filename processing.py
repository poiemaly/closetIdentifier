...
# path to the folder that contains "img" and "anno"
DATA_ROOT = r"E:\school\vscode_projects\outfitGenerator\kaggel\Deepfashion_dataset"   # <--- TODO: edit this

LABELS_CSV = os.path.join(DATA_ROOT, "anno", "anno", "train_labels.csv")
IMG_ROOT = os.path.join(DATA_ROOT)   # because image_name already starts with "img\..."

# pick a few categories so the task is manageable
SELECTED_CATEGORIES = ["Blouse", "Blazer", "Cardigan", "Tank", "Hoodie"]
MAX_PER_CLASS = 400   # shrink dataset here
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
EPOCHS = 12            # you can increase later if training is fast
